...
(function GeoLocation (window, document, $) {
  ...
  $.map.getGeolocation = function (options) {
    ...
    getGeoLocationFromBrowser(options);
  };
  ...
  function getGeoLocationFromBrowser (options) {
    ...
    window.navigator.geolocation.getCurrentPosition(function (position) {
      ...
      console.log("%cGeolocation Error: %c%s", "color:red", "", error.message);
